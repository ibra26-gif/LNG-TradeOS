// Vercel serverless proxy for GIE AGSI+ Underground Storage API
// Env var: AGSI_API_KEY
// Base URL: https://agsi.gie.eu/api
// Attribution REQUIRED: "Source: GIE AGSI+" on all outputs.
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.error('AGSI proxy error:', err);
